...
//            let createdDreamID = try await FirebaseDreamService.shared.createDreamWithImage(dream: newDream)
            let createdDreamID = try await FirebaseDreamService.shared.createDream(dream: newDream)
