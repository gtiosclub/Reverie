...
//test dreams
let d1 = DreamModel(userID: "hi", id: "hi", title: "get", date: Date(), loggedContent: "hi", generatedContent: "hi", tags: [DreamModel.Tags.animals, DreamModel.Tags.forests], image: "hi", emotion: DreamModel.Emotions.sadness)

let d2 = DreamModel(userID: "hi", id: "hi", title: "hey", date: Date(), loggedContent: "hi", generatedContent: "hi", tags: [DreamModel.Tags.mountains, DreamModel.Tags.forests, DreamModel.Tags.animals, DreamModel.Tags.rivers, DreamModel.Tags.school, DreamModel.Tags.school], image: "hi", emotion: DreamModel.Emotions.happiness)
